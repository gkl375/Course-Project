...
| Issue | What to try |
|--------|-------------|
| `ModuleNotFoundError: No module named 'heap_heapsort'` | Run from the folder that **contains** `heap_heapsort/`, or set `PYTHONPATH` to that folder. |
| Diagrams or plots missing | `pip install matplotlib`. |
| Windows console garbled text | Use a UTF-8 terminal or your IDE’s integrated terminal. |
